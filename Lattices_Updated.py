...
class Lattice:
    ...
    m_K = 0.039964/6.022E23 #Mass of potassium 40.
    ...
    def Tunneling(self):
        ...
        self.Jex = np.dot(Phase_Matrix, self.Energies[:,1])
        self.Jex = np.real(self.Jex - Phase_Matrix[:,0] * self.Energies[0,1])/(self.N_Quasimomenta-1)
        return
