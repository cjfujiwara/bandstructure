function [npt,output] = calculateLatticeHarmonicHamiltonian(npt,opts)
n = opts.NumSites;                  % Total number of sites
jjMax = opts.MaxTunnelingOrder;     % Maximum tunneling order
Tmat = makeTmatrix(n,jjMax);        % Tunneling Matrix with PBC
Omega = opts.Omega;                 % Harmonic Energy per site En=Omega*n^2
nBands = opts.NumBands;             % Number of bands
fr = npt.fr;                        % Recoil Energy
